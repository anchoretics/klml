...
.desc{float:left;height:180px;width:430px;padding-top:40px;text-align:center;color:#858585;font-size:28px;font-weight:bold;}
	/* background:url('${ctx}/static/back/images/admin_logo.png') no-repeat center 8px; */
...
<div class="center div2">&copy; 2015 <a href="http://www.jspxcms.com/" target="_blank">准东经济技术开发区</a> All Rights Reserved</div>
</body>
</html>